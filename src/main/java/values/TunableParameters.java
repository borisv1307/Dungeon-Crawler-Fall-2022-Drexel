...
public final class TunableParameters {
	...
	public static final int ENEMY_SPAWN_EVERY_N_FRAMES = 13;
	public static final int ENEMY_FIRE_EVERY_N_FRAMES = 9;
	...
	public static final int HORIZONTAL_RANDOM_ENEMY_SPAWN_OFFSET = 1;
