...
public class TilePainterTest {
    ...
    public void paint_tiles() {
        ...
        Mockito.when(game.getTileFromCoordinates(1, 1)).thenReturn(TileType.KEY);
        ...
        Mockito.when(game.getTileFromCoordinates(1, 5)).thenReturn(TileType.ENEMY);
        ...
        inOrder.verify(graphics).fillRect(10, 100, 10, 20);
    ...
    public void paint_player() {
        ...
        Mockito.verify(graphics).fillRect(20, 120, 10, 20);
    }
